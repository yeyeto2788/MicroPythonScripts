...
def main():
    ...
    html = """<!DOCTYPE html>
        ...
        input[type=submit]{ background-color: #424242; border: 3px; color: #fff; padding: 4px; text-decoration: none; margin: auto; cursor: pointer; width:30em; font-weight: bold}
        form {text-align: center;}
        </style>
        </head>
        <body>
        <div>
        <div class="h1_div"><h1 align="center" style="color:#ffffff;"><a href="http://192.168.4.1">Micro Turntable</a></h1></div><div>
        <form><br><h2>Parameters:</h2><br><table align="center">
    ...
    while True:
        ...
        print("Got angle=%s, delay=%s and count=%s" % (str(angle), str(delay), str(count)))
        if angle > 0:
